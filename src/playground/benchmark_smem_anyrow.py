...
import argparse
from gorby_kronecker import kronecker_smem_anyrow_product
...
if __name__ == "__main__":
	...
	gorby_result = kronecker_smem_anyrow_product(A, B)

	print(f"Result: {gorby_result}")
	print(f"All Close: {torch.allclose(gorby_result, torch.kron(A, B))}")
